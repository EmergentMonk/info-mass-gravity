...
- QEC Test Contributor: [Contributor requesting citation]
...
def run_qec_demonstration():
    ...
    print("QEC Test Contributor: [Contributor requesting citation]")
    ...
    print("Citations: Slade, Vetro, Vopson, Verlinde, [QEC Contributor]")
    print("=" * 80)
